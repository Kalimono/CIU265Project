...
public class DragAndDropWindow : EditorWindow
{
    ...
    public void CreateGUI()
    {
        ...
        // Import UXML
        var visualTree = AssetDatabase.LoadAssetAtPath<VisualTreeAsset>("Assets/Editor/DragDrop/DragAndDropWindow.uxml");
        
        VisualElement labelFromUXML = visualTree.Instantiate();
        //Button b1 = new Button();
        //b1.name = "button";
        //labelFromUXML.Add(b1);
        ...
        new(rootVisualElement.Q<VisualElement>("object2"));
    }
}